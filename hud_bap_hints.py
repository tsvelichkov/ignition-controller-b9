...
HUD_NAV_HINTS = {
    ...
    0x0E: "If HUD provides payload, mirror it back as nav status for now.",
    ...
    0x14: "Reply with current NavigationSessionState payload.",
    0x17: "Reply with maneuver descriptor based on current arrow preset.",
    0x18: "Special request: choose init vs active display config payload.",
    0x25: "Reply with function sync payload matching current nav phase.",
    0x26: "Reply with InfoStates status.",
    0x36: "Special handshake: echo value and optionally seed nav bundle.",
}
